...
```bash
git remote add encore encore://motolink-kenya-bike-rentals-8q62
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/motolink-kenya-bike-rentals-8q62/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/motolink-kenya-bike-rentals-8q62/settings/integrations/github)
